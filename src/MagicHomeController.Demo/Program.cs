...
namespace MagicHomeController.Demo
{
	class Program
	{
		static void Main(string[] args)
		{
			...
			IEnumerable<DeviceFindResult> findResults = DeviceFinder.FindDevices(new IPEndPoint(IPAddress.Parse("192.168.178.255"), 48899)); // find ip, mac and model of all devices in network
